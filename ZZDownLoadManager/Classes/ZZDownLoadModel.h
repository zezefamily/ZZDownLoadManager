...
typedef NS_ENUM(NSInteger, ZZDownloadState) {
    ZZDownloadStateDefault = 0,     // 默认
    ZZDownloadStateDownloading,     // 正在下载
    ZZDownloadStateWaiting,         // 等待
    ZZDownloadStatePaused,          // 暂停
    ZZDownloadStateFinish,          // 完成
    ZZDownloadStateError,           // 错误
};
...
@property (nonatomic, assign) ZZDownloadState state;        // 下载状态
